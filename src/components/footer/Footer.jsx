        ...
        <div className="pie-pagina py-2">
          <div className="d-flex row gx-0 justify-content-lg-evenly justify-content-center align-items-center">
            ...
            <a href="/">
                  ...
                  <img
                    className="img-fluid"
                    src={`/assets/Marca_de_agua_2.png`}
                    alt="logo"
                  />
                </a>
            </div>
            ...
            <div className="col-9 col-lg-2 py-4 d-flex flex-column align-items-center">
              ...
              <div>
              <a className='m-2' target="_blank" href="https://instagram.com/am.creacioness?igshid=YmMyMTA2M2Y=">
            ...
            <div className="col- col-lg-2 d-flex justify-content-center py-4">
              <img className='img-fluid' src={`/assets/footer/dataFiscal.jpeg`} alt="DataFiscal" />
            </div>
          </div>
        </div>
      </div>
      <div className="grupo-2 py-3">
        <small>
